...
# ---- Configuração
SAMPLE_SIZE = 20000  # número máximo de linhas para análise/plot (ajuste se quiser mais/menos)
...
# Transformar amostra no espaço do KMeans
...
# Centróides do KMeans no espaço transformado
kmeans_step = pipeline.named_steps['classifier']
centroids = kmeans_step.cluster_centers_

# Projetar centróides no PCA
centroids_pca = pca.transform(centroids)

# Plot rápido (só a amostra)
